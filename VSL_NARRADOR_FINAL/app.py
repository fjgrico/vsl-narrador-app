...
# Contenido del nuevo app.py con mensaje visual previo al envío
codigo_app_py = '''
...
# Guardar en archivo
archivo_app = Path("app.py")
archivo_app.write_text(codigo_app_py.strip(), encoding="utf-8")

"✅ Archivo app.py actualizado correctamente con mensaje de carga inicial."
